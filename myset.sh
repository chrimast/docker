...
EOF
  ...
  while true; do
    ...
    case $sub_choice in
      ...
      wget -O /home/web/docker-compose.yml https://raw.githubusercontent.com/chrimast/docker/main/LNMP-docker-compose-10.yml
    ...
    while true; do
        ...
        case $sub_choice in
            ...
            4)
                install goaccess
                goaccess --log-format=COMBINED /home/web/nginx/log/access.log
    ...
    35)
        ...
        if docker inspect fail2ban &>/dev/null ; then
          while true; do
              ...
              echo "11. 配置拦截参数"
              echo "------------------------"
              echo "21. cloudflare模式（需要先安装nginx）"
              echo "------------------------"
              echo "9. 卸载防御程序"
              echo "------------------------"
              echo "0. 退出"
              ...
              case $sub_choice in
                  1)
                      sed -i 's/false/true/g' /home/fail2ban/config/fail2ban/jail.d/alpine-ssh.conf
                      sed -i 's/false/true/g' /home/fail2ban/config/fail2ban/jail.d/linux-ssh.conf
                      sed -i 's/false/true/g' /home/fail2ban/config/fail2ban/jail.d/centos-ssh.conf
                      f2b_status
                      ;;
                  2)
                      sed -i 's/true/false/g' /home/fail2ban/config/fail2ban/jail.d/alpine-ssh.conf
                      sed -i 's/true/false/g' /home/fail2ban/config/fail2ban/jail.d/linux-ssh.conf
                      sed -i 's/true/false/g' /home/fail2ban/config/fail2ban/jail.d/centos-ssh.conf
                      f2b_status
                      ;;
                  3)
                      sed -i 's/false/true/g' /home/fail2ban/config/fail2ban/jail.d/nginx-docker-cc.conf
                      f2b_status
                      ;;
                  4)
                      sed -i 's/true/false/g' /home/fail2ban/config/fail2ban/jail.d/nginx-docker-cc.conf
                      f2b_status
                      ;;
                  5)
                      echo "------------------------"
                  ...
                  11)
                      install nano
                      nano /home/fail2ban/config/fail2ban/jail.d/nginx-docker-cc.conf
                      f2b_status
                  ...
                  21)
                      ...
                      sed -i "/^action =/ s/$/, iptables-allports/" /home/fail2ban/config/fail2ban/jail.d/nginx-docker-cc.conf
          ...
          cd /home/fail2ban/config/fail2ban/jail.d/
          curl -sS -O https://raw.githubusercontent.com/kejilion/config/main/fail2ban/nginx-docker-cc.conf
          sed -i "/cloudflare/d" /home/fail2ban/config/fail2ban/jail.d/nginx-docker-cc.conf
